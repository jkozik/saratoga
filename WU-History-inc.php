<?php
$debug = false; 
echo "<!-- WU-History.php Version 2.7 -->";
/*------------------------------------------------
//WU-History.php
...
$WunderWrong = true;
//
$timezone   = "America/Chicago";                    // Change to your TZ.  Ken True has a list available at http://saratoga-weather.org/timezone.txt  
$WUID       = "KWIMAUST1";                          // Your stations Wunderground ID
$units      = "B";                                  // Default units which are changeable at runtime.  "M" for Metric, "E" for English or "B" for Both
$birthday   = "02-06-2005";                         // Stations first day of operation format dd-mm-yyyy.  This will determine years on the date selector.
...
if ($mode == 1) {
	...
	echo '<td class="nobr noprint"><a href="' . $PHP_SELF . '?ID=' . $WUID . '&amp;month=' . $ndate[mon] . '&amp;day=' . $ndate[mday] . '&amp;year=' . $ndate[year] . '&amp;units=' . $units . '&amp;mode=' . $mode . '">&laquo; ' . $Lprev . ' ' . $Ltarget[0] . '</a></td>';
} elseif ($mode == 2) {
	$ndate = AddDate($mo, $da, $yr, -7);
	echo '<td class="nobr noprint"><a href="' . $PHP_SELF . '?ID=' . $WUID . '&amp;month=' . $ndate[mon] . '&amp;day=' . $ndate[mday] . '&amp;year=' . $ndate[year] . '&amp;units=' . $units . '&amp;mode=' . $mode  . '">&laquo; ' . $Lprev . ' ' . $Ltarget[1] . '</a></td>';
} elseif ($mode == 3) {
	$ndate = AddDate($mo, $da, $yr, -30);
	echo '<td class="nobr noprint"><a href="' . $PHP_SELF . '?ID=' . $WUID . '&amp;month=' . $ndate[mon] . '&amp;day=' . $ndate[mday] . '&amp;year=' . $ndate[year] . '&amp;units=' . $units . '&amp;mode=' . $mode  . '">&laquo; ' . $Lprev . ' ' . $Ltarget[2] . '</a></td>';
} elseif ($mode == 4) {
	$ndate = AddDate($mo, $da, $yr, -365);
	echo '<td class="nobr noprint"><a href="' . $PHP_SELF . '?ID=' . $WUID . '&amp;month=' . $ndate[mon] . '&amp;day=' . $ndate[mday] . '&amp;year=' . $ndate[year] . '&amp;units=' . $units . '&amp;mode=' . $mode  . '">&laquo; ' . $Lprev . ' ' . $Ltarget[3] . '</a></td>';
}		
?>		
...
if ($mode == 1) {
	$ndate = AddDate($mo, $da, $yr, +1);
	echo '<td class="nobr noprint"><a href="' . $PHP_SELF . '?ID=' . $WUID . '&amp;month=' . $ndate[mon] . '&amp;day=' . $ndate[mday] . '&amp;year=' . $ndate[year] . '&amp;units=' . $units . '&amp;mode=' . $mode . '">' . $Lnext . ' ' . $Ltarget[0] . ' &raquo;</a></td>';
} elseif ($mode == 2) {
	$ndate = AddDate($mo, $da, $yr, +7);
	echo '<td class="nobr noprint"><a href="' . $PHP_SELF . '?ID=' . $WUID . '&amp;month=' . $ndate[mon] . '&amp;day=' . $ndate[mday] . '&amp;year=' . $ndate[year] . '&amp;units=' . $units . '&amp;mode=' . $mode  . '">' . $Lnext . ' ' . $Ltarget[1] . ' &raquo;</a></td>';
} elseif ($mode == 3) {
	$ndate = AddDate($mo, $da, $yr, +30);
	echo '<td class="nobr noprint"><a href="' . $PHP_SELF . '?ID=' . $WUID . '&amp;month=' . $ndate[mon] . '&amp;day=' . $ndate[mday] . '&amp;year=' . $ndate[year] . '&amp;units=' . $units . '&amp;mode=' . $mode  . '">' . $Lnext . ' ' . $Ltarget[2] . ' &raquo;</a></td>';
} elseif ($mode == 4) {
	$ndate = AddDate($mo, $da, $yr, +365);
	echo '<td class="nobr noprint"><a href="' . $PHP_SELF . '?ID=' . $WUID . '&amp;month=' . $ndate[mon] . '&amp;day=' . $ndate[mday] . '&amp;year=' . $ndate[year] . '&amp;units=' . $units . '&amp;mode=' . $mode  . '">' . $Lnext . ' ' . $Ltarget[3] . ' &raquo;</a></td>';
}		
?>				
		</tr>
	</table>
	...
	if ($mode == 1) {
		...
		for ($row=0; $row<count($csvarray); $row++) {
			...
			for ($col=0; $col<$columns; $col++) {
				...
				if ($col == 0) $data = substr($data,11,5);  //Date/Time

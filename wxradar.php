...
if (isset($SITE['fcstorg']) and $SITE['fcstorg'] == 'NWS') {

    include_once("WU-radar-inc.php"); // Use WU Radar
	
} else if (isset($SITE['fcstorg']) and $SITE['fcstorg'] == 'EC') {
    $doInclude = true;
	$doPrint = true;
...
?>
      ...
      <img src="http://maps.wunderground.com/data/640x480/2xus_rd.gif" alt="Radar" width="640" height="480"/>
<?php } // end of not-NWS, not-EC radar ?>
</div><!-- end main-copy -->

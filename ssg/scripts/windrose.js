...
//                    $('#canvas_rose').css({
//                        'box-shadow': offset + 'px ' + offset + 'px ' + offset + 'px ' + gauges.gauge.shadowColour,
//                        'border-radius': Math.floor(_gaugeSize / 2) + 'px'
//                    });
                }
...
*/
        ...
        doWindRose = function () {
            ...
            if (_ctxRoseGauge && !_firstRun) {
                ...
                // Paint the rose plot
                offset = (_gaugeSize - _rosePlotSize) / 2;
